...
$.fn.validatebox.defaults={required:false,validType:null,delay:200,missingMessage:"必选项",invalidMessage:null,tipPosition:"right",deltaX:0,tipOptions:{showEvent:"none",hideEvent:"none",showDelay:0,hideDelay:0,zIndex:"",onShow:function(){
...
},message:"请输入一个合法的Email地址"},url:{validator:function(_3e9){
...
},message:"请输入一个合法的URL地址"},length:{validator:function(_3ea,_3eb){
var len=$.trim(_3ea).length;
return len>=_3eb[0]&&len<=_3eb[1];
},message:"请输入一个长度{0}-{1}的值"},remote:{validator:function(_3ec,_3ed){
var data={};
data[_3ed[1]]=_3ec;
...
//td.addClass("datagrid-td-merged");修改byZJL
...
function _65f(_660){
var _661=_660?1:2;
for(var i=parseInt(_65d)+1;i<data.rows.length;i++){
...
$.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {frozenColumns: undefined, columns: undefined, fitColumns: false, resizeHandle: "right", autoRowHeight: true, toolbar: null, striped: false, method: "post", nowrap: true, idField: null, url: null, data: null, loadMsg: "Processing, please wait ...", rownumbers: false, singleSelect: false, selectOnCheck: true, checkOnSelect: true, pagination: false, pagePosition: "bottom", pageNumber: 1, pageSize: 10, pageList: [20, 30, 40, 50], queryParams: {}, sortName: null, sortOrder: "asc", remoteSort: true, showHeader: true, showFooter: false, scrollbarSize: 18, rowStyler: function (_666, _667) {
