...
{
    /// <summary>
    /// SetAlarmHandler 的摘要说明
    /// </summary>
    public class SetAlarmHandler : BaseHandler
    {
        ...
        public override void DoLoginedHandlerWork(HttpContext context)
        {
            ...
            try
            {
                switch (AjaxType)
                {
                    ...
                    SearchCondition sCondition = new SearchCondition() { TBName = "IoT_SetAlarm", TFieldKey = "RegisterDate", TTotalCount = -1, TPageCurrent = 1, TFieldOrder = "RegisterDate DESC", TWhere = Where };
                    ...
                    sCondition = new SearchCondition() { TBName = "View_AlarmMeter", TFieldKey = "UserID", TTotalCount = -1, TPageCurrent = 1, TFieldOrder = "UserID DESC", TWhere = Where };
