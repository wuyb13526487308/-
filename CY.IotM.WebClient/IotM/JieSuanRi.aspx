<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JieSuanRi.aspx.cs" Inherits="CY.IotM.WebClient.IotM.JieSuanRi" %>
...
<head runat="server">
    ...
    <script src="../Scripts/IotM/IotM.JieSuanRi.js"></script>

    <script type="text/javascript">
        //$(function () {
        //    IotM.CheckLogin();
        //    IotM.JieSuanRi.LoadDataGrid();
        ...
        $.extend($.fn.validatebox.defaults.rules, {
            DateRex: {
                validator: function (value) {
                    var rex = /^\d{1,2}$/;
                    if (rex.test(value)) {
                        if (parseInt(value, 10) <= 28 && parseInt(value, 10) >= 1) {
                            return true;
                        } else {
                            return false;
                        }
...
<body>
    ...
    <div id="wrap">
        <div id="tb">
            ...
            <a href="#" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-search'" id="btnSelect" onclick="IotM.JieSuanRi.SerachClick()">查询</a>
            &nbsp;&nbsp;&nbsp;&nbsp;
           <a href="#" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-edit'" id="btnKaiFa" onclick="IotM.JieSuanRi.OpenformAdd()">设置结算日</a>
        ...
        <div id="wAdd" class="easyui-window" title="设置结算日" data-options="modal:true,closed:true,iconCls:'icon-add'"
                        ...
                        <td>
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-add'" id="btnSelAllUser" onclick="IotM.JieSuanRi.SelAllUser()">所有用户</a><br />
                                        <a href="#" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-add'" id="btnSelCommunity" onclick="IotM.JieSuanRi.SelCommunity()">选择小区</a><br />
                                        <a href="#" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-add'" id="btnSelUser" onclick="IotM.JieSuanRi.SelUser()">选择用户</a><br />
                                        <a href="#" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-reload'" id="btnClean" onclick="IotM.JieSuanRi.CleanSelect()">清除选择</a><br />
                        ...
                        <td valign="top">
                            <%--<table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input class="easyui-validatebox" required="true" missingmessage="请输入时" data-options="validType:'HourRex'" type="text" name="txtHour" id="txtHour" />时
                                        </td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        ...
                                        <td>
                                            <input class="easyui-validatebox" required="true" missingmessage="请输入分" data-options="validType:'MinuRex'" type="text" name="txtMinute" id="txtMinute" />分
                                        </td>
                                    </tr>
                                </table>--%>
                            <input class="easyui-numberspinner" required="true" style="width: 80px;" data-options="min:1,max:12,editable:false" type="text" name="txtMouth" id="txtMouth" />月
                            <input class="easyui-numberspinner" required="true" style="width: 80px;" data-options="min:1,max:31,editable:false" type="text" name="txtDate" id="txtDate" />日
                        </td>
    ...
    <div id="deleteUserDiv" class="easyui-window" data-options="modal:true,closed:true,iconCls:'icon-add'"
        ...
        <div id="tb_deleteUser">
            ...
            <a href="#" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-search'" id="btnSelectDel" onclick="IotM.JieSuanRi.SerachClickUser()">查询</a>
            &nbsp;&nbsp;&nbsp;&nbsp;
