...
<body>
    ...
    <div id="tb">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;表状态&nbsp;&nbsp;  <input class="easyui-combobox" type="text" name="CNState"  id="CNState" default="" />
                   ...
                   <tr>
                            ...
                            <td colspan="4" align="center">
                                <a href="#" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-ok'"
                                    id="btnOk"">完成</a> <a href="#" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-cancel'"
                                        id="btnCancel">取消</a>
                            </td>
